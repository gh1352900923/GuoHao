 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = initial*pow(percent/100+1,3)
 ...
 */
fun numberRevert(number: Int): Int = (number%1000)/100+(number%100)/10*10+(number%10)*100
